...
keystore is available here - the newest is `CardWallet_top_back.apk` (2026-09-17, rounds
...
signature, and `apk_content_check.py` 94/94 against `CardWallet_top_back.apk` (the
