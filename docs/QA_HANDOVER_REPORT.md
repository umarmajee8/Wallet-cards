...
against `CardWallet_floating_pill.apk` (11,669,816 B, sha256
...
point at `CardWallet_floating_pill.apk` (its sha256/size on the download page describe the file it serves).
