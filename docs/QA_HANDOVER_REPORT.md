...
against `CardWallet_bottom_centered.apk` (11,669,825 B, sha256
...
point at `CardWallet_bottom_centered.apk` (its sha256/size on the download page describe the file it serves).
